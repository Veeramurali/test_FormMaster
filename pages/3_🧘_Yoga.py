...
def count_time(time_interval):
    ...
    if current_second != last_second:
        ...
        if counter == time_interval + 1:
            counter = 0
            pose_number += 1
            playsound(r'D:\GIT\AI-Fitness-Trainer\models\bell.wav')
            if pose_number == 5:
                pose_number = 1
...
img1 = Image.open(r"D:\GIT\AI-Fitness-Trainer\models\gif\yoga.gif")

img2 = Image.open("D:\GIT\AI-Fitness-Trainer\models\images\pranamasana2.png")
img3 = Image.open("D:\GIT\AI-Fitness-Trainer\models\images\Eka_Pada_Pranamasana.png")
img4 = Image.open("D:\GIT\AI-Fitness-Trainer\models\images\Ashwa_Sanchalanasana.webp")

img5 = Image.open(r"D:\GIT\AI-Fitness-Trainer\models\images\ardha_chakrasana.webp")
img6 = Image.open(r"D:\GIT\AI-Fitness-Trainer\models\images\Utkatasana.png")
img7 = Image.open(r"D:\GIT\AI-Fitness-Trainer\models\images\Veerabhadrasana2.png")
