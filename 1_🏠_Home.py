...
st.set_page_config(page_title="Fitness Trainer", page_icon="https://cdn4.iconfinder.com/data/icons/SUPERVISTA/education_icons/png/400/physical_education.png"
, layout="wide")
...
local_css("D:\GIT\AI-Fitness-Trainer\models\styles\styles.css")
...
with st.container():
    ...
    with text_column:
        ...
        st.markdown("[Have a Listen...](https://open.spotify.com/playlist/1VU91WcVhly4DClcCJB0AE)")
with st.container():
    image_column, text_column = st.columns((1, 2))
    with image_column:
    ...
    with text_column:
        ...
        st.markdown("[Have a listen...](https://open.spotify.com/show/74Tuzlh4k1Jcu58fXhElEQ?si=1b6b96112cdc4434)")
...
with st.container():
    ...
    # Update the action URL to Formspree
    contact_form = """
    <form action="https://formspree.io/f/xqakppeo" method="POST">
